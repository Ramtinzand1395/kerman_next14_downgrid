...
//           اگر برای انتخاب بازی PS4 یا PS5، خرید کنسول، بررسی لوازم جانبی گیمینگ یا
//           پیگیری سفارش سوالی دارید، اینجا سریع‌ترین راه ارتباط با ماست. کارشناسان
//           کرمان آتاری با پاسخ‌گویی دقیق و صمیمانه کنار شما هستند.
//         </p>
//       </header>
...
//           <p className="mt-3 text-sm leading-7 text-slate-200">
//             اگر فروشنده یا مجموعه فعال در حوزه گیم هستید، از طریق فرم تماس درخواست
//             همکاری ثبت کنید.
//           </p>
//         </article>
//       </section>
...
const faqItems = [
  {
    question: "چقدر زمان می‌برد تا به پیام من پاسخ داده شود؟",
    answer: "در ساعات کاری معمولاً کمتر از ۲ ساعت و حداکثر تا ۲۴ ساعت کاری پاسخ داده می‌شود.",
  },
  {
    question: "آیا امکان خرید حضوری بازی و کنسول وجود دارد؟",
    answer:
  ...
  return (
    <section className="mx-auto max-w-7xl px-5 py-12 md:py-16">
      ...
      <header className="mb-10 rounded-3xl bg-gradient-to-l from-blue-50 via-white to-slate-50 p-6 md:p-10">
        ...
        <p className="mt-4 max-w-3xl text-sm leading-8 text-slate-600 md:text-base">
          اگر برای انتخاب بازی PS4 یا PS5، خرید کنسول، بررسی لوازم جانبی گیمینگ یا پیگیری سفارش
          سوالی دارید، اینجا سریع‌ترین راه ارتباط با ماست. کارشناسان کرمان آتاری با پاسخ‌گویی
          دقیق و صمیمانه کنار شما هستند.
        </p>
      </header>
      ...
      <section className="mt-12 grid gap-6 rounded-3xl bg-slate-900 p-6 text-white md:grid-cols-3 md:p-8">
        <article>
          <h2 className="text-lg font-bold">مشاوره قبل از خرید</h2>
          <p className="mt-3 text-sm leading-7 text-slate-200">
            با بررسی بودجه، سبک بازی و مدل کنسول شما، بهترین پیشنهاد ممکن را ارائه می‌کنیم.
          </p>
        </article>
        <article>
          <h2 className="text-lg font-bold">پشتیبانی بعد از خرید</h2>
          <p className="mt-3 text-sm leading-7 text-slate-200">
            برای فعال‌سازی، نصب، مشکلات اجرایی یا راهنمایی استفاده از محصولات همراه شما هستیم.
          </p>
        </article>
        <article>
          <h2 className="text-lg font-bold">همکاری تجاری</h2>
          <p className="mt-3 text-sm leading-7 text-slate-200">
            اگر فروشنده یا مجموعه فعال در حوزه گیم هستید، از طریق فرم تماس درخواست همکاری ثبت کنید.
          </p>
        </article>
      </section>

      <section className="mt-12 rounded-3xl border border-slate-200 bg-white p-6 md:p-10">
        <h2 className="text-2xl font-bold text-slate-900">سوالات متداول تماس با ما</h2>
        <div className="mt-6 space-y-4">
          {faqItems.map((item) => (
            <article key={item.question} className="rounded-2xl bg-slate-50 p-4 md:p-5">
