...
//     e.preventDefault();
//     alert(
//       "پیام شما با موفقیت ثبت شد. کارشناسان ما به‌زودی با شما تماس می‌گیرند.",
//     );
...
//             برای مشاوره خرید بازی و کنسول، استعلام موجودی، پیگیری سفارش یا دریافت
//             پشتیبانی فنی، فرم زیر را تکمیل کنید.
//           </p>
//         </div>
...
//         <button
//           type="submit"
//           className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-blue-600 px-6 py-3 text-sm font-semibold text-white transition hover:bg-blue-700"
//         >
