...
// //   const handleSubmit = () => {
// //     const adminMessage = [
// //       "درخواست جدید خرید بازی",
// //       `کنسول: ${selectedConsole?.title} - ${selectedConsole?.subtitle}`,
// //       `نوع اکانت: ${selectedAccountType?.title} - ${selectedAccountType?.subtitle}`,
// //       `بازی‌ها: ${
// //         selectedGames
// //           .map((game) => `${game.name} (${game.platform})`)
// //           .join("، ") || "بدون انتخاب"
// //       }`,
// //     ].join("\n");
...
// //       gameAccountType: selectedAccountType,
// //       selectedGames,
// //       adminMessage,
// //     };

// //     console.log("Game order request:", payload);
// //     alert("درخواست شما ثبت شد. اطلاعات سفارش در کنسول مرورگر نمایش داده شد.");
// //   };
...
// //               کنسول، نوع اکانت و بازی‌های موردنظرت را انتخاب کن تا پیام سفارش
// //               برای ادمین آماده شود.
// //             </p>
// //           </div>
...
// //               number="۴"
// //               title="خلاصه درخواست"
// //               description="انتخاب‌ها را بررسی کن و درخواست را ارسال کن."
// //             />
...
// //                 <h4 className="font-black text-slate-950">بازی‌های انتخابی</h4>
...
// //               className="mt-6 w-full rounded-2xl bg-[#001A6E] px-5 py-4 text-sm font-black text-white shadow-lg shadow-indigo-950/20 transition hover:-translate-y-0.5 hover:bg-[#000e3c]"
// //             >
// //               ثبت و ارسال درخواست
// //             </button>
// //           </aside>
...
// //     // WhatsApp example:
// //     // window.open(`https://wa.me/989123456789?text=${encodeURIComponent(adminMessage)}`, "_blank");

// //     // Backend / Telegram bot example:
...
// //                       className="flex items-center gap-3 rounded-2xl border border-slate-200 bg-white p-3 transition hover:-translate-y-0.5 hover:border-indigo-200 hover:shadow-lg hover:shadow-slate-200/70"
// //                     >
// //                       <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-[#001A6E] to-indigo-500 text-lg font-black text-white">
// //                         {game.name.slice(0, 1)}
// //                       </div>
// //                       <div className="min-w-0 flex-1">
// //                         <h4 className="truncate text-sm font-black text-slate-950">
...
//       errors.address = "آدرس الزامی است (حداقل ۱۰ کاراکتر).";
//     }
...
//                       className={`w-full rounded-2xl border bg-white px-4 py-3 text-right text-sm font-semibold text-slate-900 outline-none transition placeholder:text-slate-400 focus:ring-4 ${
//                         fieldErrors.phone
//                           ? "border-red-300 focus:border-red-400 focus:ring-red-100"
//                           : "border-slate-200 focus:border-[#001A6E] focus:ring-indigo-100"
//                       }`}
...
//                       className={`w-full resize-none rounded-2xl border bg-white px-4 py-3 text-sm font-semibold text-slate-900 outline-none transition placeholder:text-slate-400 focus:ring-4 ${
//                         fieldErrors.address
//                           ? "border-red-300 focus:border-red-400 focus:ring-red-100"
//                           : "border-slate-200 focus:border-[#001A6E] focus:ring-indigo-100"
//                       }`}
