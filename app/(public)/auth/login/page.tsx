...
export default function LoginWithOtp() {
  ...
  // پس از منقضی شدن کد (OTP_TOTAL_TIME)، فرم به‌صورت خودکار به مرحله شماره موبایل بازگردانده می‌شود
  useEffect(() => {
    ...
    setEnteredOtp("");
    setOtpId(null);
    toast.info("زمان وارد کردن کد به پایان رسید؛ لطفاً دوباره کد دریافت کنید.");
  }, [otpSent, timer]);
