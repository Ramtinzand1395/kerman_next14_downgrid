          ...
          <div className="flex gap-2">
            <button
              ...
              className={`rounded-lg px-3 py-2 text-sm ${
                filterMode === "all" ? "bg-gray-900 text-white" : "border text-gray-700"
              }`}
            >
              همه
            </button>
            <button
              ...
              className={`rounded-lg px-3 py-2 text-sm ${
                filterMode === "unread" ? "bg-gray-900 text-white" : "border text-gray-700"
              }`}
            >
              خوانده‌نشده
            </button>
            <button
              ...
              className={`rounded-lg px-3 py-2 text-sm ${
                filterMode === "read" ? "bg-gray-900 text-white" : "border text-gray-700"
              }`}
            >
              خوانده‌شده
            </button>
