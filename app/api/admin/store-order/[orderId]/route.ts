...
export async function PUT(
  ...
  try {
    ...
    let smsResponse: Awaited<ReturnType<typeof senSMS>> | null = null;
    ...
    const smsFailed = sendSms && smsResponse !== null && !smsResponse.ok;

    return NextResponse.json({
      message: smsFailed
        ? "سفارش تغییر کرد، اما ارسال پیامک ناموفق بود."
        : "سفارش تغییر کرد.",
      data: order,
      sms: smsResponse,
      smsOk: !smsFailed,
